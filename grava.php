...
<?php
    $link=mysqli_connect("Localhost", "root", "root" )
      ...
      mysqli_select_db($link,"ohms") or die ("Banco de dados nao disponivel");
        ...
        $consulta="Insert into equipamentos (Codigo, Nome, Descricao, Alugado, Status, Preco)
                             values('$Codigo','$Nome','$Descricao', $Alugado, $Status, $Preco)";
